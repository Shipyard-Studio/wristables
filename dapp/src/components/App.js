...
function App() {
  ...
  return (
      ...
      <div className="App" id="outer-container">
        ...
        <Section bg={bg3} Component={TextSection} componentProps={{header: "Community", body: "<div>Our owners become a part of a community ofwatch collectors and enthusiasts that can hold ontotheir time piece as it appreciates, or trade it and passalong the benefits to another collector.</div>"}}/>
        ...
        <Section bg={bg5} Component={TextSection} componentProps={{header: "Membership", body: "<div>Your tmembership will give you first dibs atpurchasing any new releases from Wrist Aficionado.Along with access to private VIP events that can onlybe accessed with wallet verification.</div>"}}/>
