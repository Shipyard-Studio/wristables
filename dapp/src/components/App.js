  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <div className="App" id="outer-container">
        ...
        <Section bg={bg3} size={1} Component={TextSection} componentProps={{header: "Community", image: "/assets/Watch Still 02.png", emailCapture: true, body: "<div>Our members become a part of a community of watch collectors and enthusiasts that can hold onto their time piece as it appreciates, or trade it and pass along the benefits to another collector. Join our Discord to be apart of our community.</div>", emailCapture: true}}/>
