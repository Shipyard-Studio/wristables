  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <div className="App" id="outer-container">
        ...
        {window.innerWidth < 950 ? <Sidebar pageWrapId={'page-wrap'} outerContainerId={'outer-container'} /> : <></> }
        <ProgressBar num={sectionInFocus}/>
        <Section bg={null} size={1} Component={Hero} componentProps={{ethers: ethers, provider: provider, signer: signer, contract: contract, walletAddress: walletAddress, connect: walletConnect, openModal: openModal, chainId: chainId, pageWidth: pageWidth}}/>
