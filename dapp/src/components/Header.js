        ...
        <div className='nav-container z-40'>
            ...
            <div className='side'>
                <div className='nav-logo-flex z-40'>
                    ...
                    <a href="https://www.tiktok.com/link/v2?aid=1988&lang=en&scene=bio_url&target=https%3A%2F%2Fdiscord.gg%2Fwawc" className='m-auto mx-2 z-10 invert' target="_blank" alt="discord" rel="noreferrer"><img className="nav-logos" src={process.env.PUBLIC_URL + '/discord.png'} /></a>
